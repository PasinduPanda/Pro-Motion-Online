...
import { Search, Plus, Upload, FileText, X, Eye, Trash2 } from 'lucide-react';
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500">Manage patients and upload medical reports</p>
        </div>
          ...
          <tbody className="divide-y divide-gray-200">
            {patients.map((patient) => (
              <tr key={patient.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <button onClick={() => handleDelete(patient.id)} className="text-red-600 hover:text-red-800"><Trash2 className="w-5 h-5" /></button>
                </td>
              </tr>
            ))}
          </tbody>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button type="submit" className="btn btn-primary flex-1">Create Patient</button>
              </div>
            </form>
          </div>
        </div>
